...
class SettingsController extends GetxController {
  ...
  final _embeddingBackend = 'auto'.obs;
  ...
  Future<void> loadSettings() async {
    ...
    modelNameController.text =
        _box.read<String>('llmModelName') ?? 'deepseek-chat';

    _embeddingBackend.value =
        _box.read<String>(EmbeddingConstants.keyPreferredBackend) ?? 'auto';

    _autoTag.value = _box.read<bool>('autoTag') ?? false;
  ...
  void saveModelName(String value) {
    _box.write('llmModelName', value.trim());
  }
